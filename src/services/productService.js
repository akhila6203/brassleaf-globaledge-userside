...
//       : null,
//   onSale: Boolean(Number(item.onsale)),
//   totalSales: item.total_sales != null ? Number(item.total_sales) : null,
//   averageRating:
//     item.average_rating != null ? Number(item.average_rating) : null,
//   ratingCount: item.rating_count != null ? Number(item.rating_count) : null,
//   image: item.image_url || item.image || null,
//   imageFile: item.image_file,
//   category: item.category_name || item.category || item.categories?.[0]?.name || "",
//   categoryName: item.category_name || item.categories?.[0]?.name || "",
//   categories: item.categories || [],
// });

// const mapProductDetails = (item) => {
...
//         : null,
//     regularPrice:
//       variation.regular_price != null && variation.regular_price !== ""
...
//       item.average_rating != null ? Number(item.average_rating) : null,
//     ratingCount: item.rating_count != null ? Number(item.rating_count) : null,
//     virtual: Boolean(Number(item.virtual)),
//     downloadable: Boolean(Number(item.downloadable)),
//     variations,
//     sizes,
//     categories: item.categories || [],
//     images,
...
//     limit: result.limit,
//     pages: result.pages,
//     products: (result.data || []).map(mapProductListItem),
//   };
// };
...
//   return mapProductDetails(response.data);
// };
