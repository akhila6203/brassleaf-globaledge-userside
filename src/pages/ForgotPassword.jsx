      ...
      <div className="container-site py-12 sm:py-16">
        <div className="mx-auto max-w-xl border border-slate-200 bg-[#f7f8fa] p-6 shadow-sm sm:p-10">
          ...
          <form onSubmit={submit} className="mt-7 space-y-5">
            <div><label className="mb-2 block text-sm font-bold text-[#243346]">Email address <span className="text-red-500">*</span></label><input name="email" type="email" required className="input-field h-12 rounded-sm" /></div>
          ...
          <Link to="/profile" className="mt-5 inline-block text-sm font-bold text-[#243346] hover:text-[#D9A537]">← Back to login</Link>
        </div>
      </div>
    </main>
  );
